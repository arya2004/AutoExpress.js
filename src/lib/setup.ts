...
import { Database, RenderEngine, Structure } from "../types";
...
export const createProject = (
  ...
  createWeatherFiles({
    modelPath: path.join(apiPath, "models"),
    controllerPath: path.join(apiPath, "controllers"),
    routePath: path.join(apiPath, "routes"),
  });
